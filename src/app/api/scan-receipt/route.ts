...
- 外食・テイクアウト：レストラン・食堂・ファストフード・居酒屋での食事・持ち帰り料理 → majorCategory は必ず「外食・グルメ」
- 外食・ドリンク：カフェ・コーヒーショップでの飲み物 → majorCategory は必ず「外食・グルメ」
- 外食・デザート：カフェ・スイーツ店でのデザート → majorCategory は必ず「外食・グルメ」
- レジャー・観光フード：テーマパーク・観光地での食べ歩き → majorCategory は必ず「外食・グルメ」
