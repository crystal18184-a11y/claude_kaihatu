...
const EMOJI = {"肉類":"🥩","魚介類":"🐟","卵":"🥚","乳製品":"🥛","野菜":"🥦","果物":"🍎","きのこ":"🍄","海藻・乾物":"🌿","豆腐・大豆製品":"🫘","漬物・発酵食品":"🥒","パン":"🍞","米・麺類":"🍚","調味料・油":"🧂","飲み物":"🧃","お菓子・スナック":"🍬","アイス・冷菓":"🍦","冷凍食品":"❄️","レトルト・缶詰":"🥫","日用品":"🧴","医療・薬":"💊","化粧品・美容":"💄","衣服・靴":"👟","バッグ・アクセサリー":"👜","家電":"🔌","スマホ・PC・ガジェット":"📱","子ども用品":"🧸","文具・おもちゃ":"✏️","習い事・教育費":"📚","外食・テイクアウト":"🍱","外食・ドリンク":"🥤","外食・デザート":"🍰","レジャー・観光フード":"🎡","交通・外出":"🚃","趣味・娯楽":"🎮","その他":"📦"};
const MAJOR_MAP = {"肉類":"食費","魚介類":"食費","卵":"食費","乳製品":"食費","野菜":"食費","果物":"食費","きのこ":"食費","海藻・乾物":"食費","豆腐・大豆製品":"食費","漬物・発酵食品":"食費","パン":"食費","米・麺類":"食費","調味料・油":"食費","飲み物":"食費","お菓子・スナック":"食費","アイス・冷菓":"食費","冷凍食品":"食費","レトルト・缶詰":"食費","日用品":"日用品・生活","医療・薬":"日用品・生活","化粧品・美容":"日用品・生活","衣服・靴":"ファッション","バッグ・アクセサリー":"ファッション","家電":"電化製品・家電","スマホ・PC・ガジェット":"電化製品・家電","子ども用品":"子ども・教育","文具・おもちゃ":"子ども・教育","習い事・教育費":"子ども・教育","外食・テイクアウト":"娯楽・その他","外食・ドリンク":"娯楽・その他","外食・デザート":"娯楽・その他","レジャー・観光フード":"娯楽・その他","交通・外出":"娯楽・その他","趣味・娯楽":"娯楽・その他","その他":"娯楽・その他"};
...
export default function Home() {
  ...
  const startEditItem = (receiptId, item) => {
  ...
  return (
    <div className="min-h-screen bg-rose-50 max-w-md mx-auto pb-24">
        ...
        <div className="fixed inset-0 z-40 flex items-end justify-center">
          ...
          <div className="relative bg-white rounded-t-3xl w-full max-w-md p-4 pb-8">
            ...
            <div className="mb-3">
              ...
              <input type="text" value={editingItem.name} onChange={(e) => setEditingItem(prev => ({ ...prev, name: e.target.value }))}
            ...
            <div className="flex gap-3 mb-4">
              ...
              <div className="flex-1">
                ...
                <input type="number" value={editingItem.quantity} onChange={(e) => setEditingItem(prev => ({ ...prev, quantity: Number(e.target.value) }))}
                  className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:border-rose-400" />
              </div>
            </div>
      ...
      <div className="p-4">
        ...
        {selectedDate && (
          <div className="mt-4">
            <div className="font-bold text-gray-600 mb-2">{dayjs(selectedDate).format("M月D日")}の買い物</div>
                ...
                <div key={receipt.id} className="bg-white rounded-2xl mb-3 overflow-hidden shadow-sm">
                  {editingReceipt === receipt.id ? (
                    ...
                    <>
                      ...
                      <div className="p-3">
                        {(expandedIds.includes(receipt.id) ? receipt.items : receipt.items.slice(0, 3)).map((item, i) => (
